...
public class Constants {
    ...
    public static final List<String> SPREADSHEET_HEADERS = new ArrayList<>(Arrays.asList(SPREADSHEET_HEADER_COUNTY_NAME,
            SPREADSHEET_HEADER_LAKE_NAME, SPREADSHEET_HEADER_LAKE_ID, SPREADSHEET_HEADER_NEAREST_TOWN,
