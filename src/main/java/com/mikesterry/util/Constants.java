...
public class Constants {
    ...
    public static final String SPREADSHEET_HEADER_SPECIES_TOTAL_COUNT  = "Species Total Count";
    ...
    public static final List<String> SPREADSHEET_HEADERS = new ArrayList<>(Arrays.asList(SPREADSHEET_HEADER_LAKE_NAME,
            SPREADSHEET_HEADER_LAKE_ID, SPREADSHEET_HEADER_COUNTY_NAME, SPREADSHEET_HEADER_NEAREST_TOWN,
            SPREADSHEET_HEADER_SURVEY_DATE, SPREADSHEET_HEADER_SPECIES_TOTAL_COUNT, SPREADSHEET_HEADER_ZERO_TO_FIVE,
